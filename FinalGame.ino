...
int mode = 0;                      // sets initial level to 0
const byte leftButton = 4;          // left button pin
const byte rightButton = 5;          // right button pin
const byte slideSwtich = 7;          // slide siwtch pin
volatile bool LBP = 0;               // bool for left button
volatile bool ss = 0;              // bool for slide switch
volatile bool RBP = 0;              // bool for right button
